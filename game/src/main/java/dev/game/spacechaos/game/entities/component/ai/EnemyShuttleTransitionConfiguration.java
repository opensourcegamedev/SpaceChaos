...
public class EnemyShuttleTransitionConfiguration {
    ...
    private List<EnemyShuttleTransition> enemyTransition = new ArrayList<>();
     ...
     public void initializeEnemyTransitions() {
         enemyTransition.add(new EnemyShuttleTransition(50, 50, 3.0f, 40, false, 0));
         ...
         enemyTransition.add(new EnemyShuttleTransition(50, 50, 4.0f, 80, false, 0));
         enemyTransition.add(new EnemyShuttleTransition(50, 50, 5.0f, 120, false, 0));
    }
